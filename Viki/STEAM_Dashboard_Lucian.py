...
with tabs[4]:
    st.header("Mitspieler-Empfehlungen")
        ...
        # Cluster CSV-Dateien
    df_clustered_players = pd.read_csv(r"C:\Users\vikkl\OneDrive\Documents\WebMining_final\clustered_players.csv")
    df_final_cluster = pd.read_csv(r"C:\Users\vikkl\OneDrive\Documents\WebMining_final\final_cluster.csv")

    # Genre Datei
    df_genres = pd.read_csv(r"C:\Users\vikkl\OneDrive\Documents\WebMining_final\steam_game_genres_normalized.csv")

    # IDF Datei
    genre_idf = pd.read_csv(r"C:\Users\vikkl\OneDrive\Documents\WebMining_final\genre_idf.csv")
